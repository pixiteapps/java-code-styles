REM Installs Pixite's IntelliJ configs into your user configs.
@echo off
echo Installing Pixite IntelliJ configs...
...
echo.
echo Restart IntelliJ and/or AndroidStudio, go to preferences, and apply 'PixiteAndroid'.
exit /b
